...
public class CountryResourceIT {
    ...
    private static final String DEFAULT_I_SO_2 = "AAAAAAAAAA";
    private static final String UPDATED_I_SO_2 = "BBBBBBBBBB";
     ...
     *
     * @see com.guen.covid19stats.repository.search.CountrySearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public void createCountry() throws Exception {
        ...
        assertThat(testCountry.getSlug()).isEqualTo(DEFAULT_SLUG);
        assertThat(testCountry.getiSO2()).isEqualTo(DEFAULT_I_SO_2);
    ...
    public void getAllCountries() throws Exception {
        ...
        restCountryMockMvc.perform(get("/api/countries?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].iSO2").value(hasItem(DEFAULT_I_SO_2)));
    }
    ...
    public void getCountry() throws Exception {
        ...
        restCountryMockMvc.perform(get("/api/countries/{id}", country.getId()))
            ...
            .andExpect(jsonPath("$.iSO2").value(DEFAULT_I_SO_2));
    }
    @Test
    ...
    public void updateCountry() throws Exception {
        ...
        assertThat(testCountry.getSlug()).isEqualTo(UPDATED_SLUG);
        assertThat(testCountry.getiSO2()).isEqualTo(UPDATED_I_SO_2);
